...
import com.cc91.notificationservice.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final NoOpUserDetailsService userDetailsService;
    ...
    public SecurityConfig(NoOpUserDetailsService userDetailsService, JwtAuthenticationFilter jwtAuthenticationFilter, InternalApiAuthFilter internalApiAuthFilter) {
