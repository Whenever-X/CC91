...
import com.cc91.userservice.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(UserDetailsServiceImpl userDetailsService, JwtAuthenticationFilter jwtAuthenticationFilter, InternalApiAuthFilter internalApiAuthFilter) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // All auth endpoints are public for registration, verification,
